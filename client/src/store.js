...
const lenders = [
    { name: 'Tanay Agarwal', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
    ...
    { name: 'Tanay Agarwal', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
